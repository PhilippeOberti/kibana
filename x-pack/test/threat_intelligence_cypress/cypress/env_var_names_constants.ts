...
/**
 * The `IS_SERVERLESS` environment variable specifies whether the currently running
 * environment is serverless snapshot.
 */
export const IS_SERVERLESS = 'IS_SERVERLESS';

/**
 * The `CLOUD_SERVERLESS` environment variable specifies whether the currently running
