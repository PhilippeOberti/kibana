...
import type { EuiDataGridProps, EuiDataGridToolBarVisibilityOptions } from '@elastic/eui';
...
export interface TableProps {
  ...
  dataView: DataView;
  /**
   * Groups passed from the GroupedAlertsTable component via the renderChildComponent callback
   */
