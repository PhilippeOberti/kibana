...
import { useGroupTitleIntegration } from '../../../hooks/alert_summary/use_group_title_integration';
import React from 'react';

jest.mock('../../../hooks/alert_summary/use_group_title_integration');

describe('groupTitleRenderers', () => {
  it('should render correctly for signal.rule.id field', () => {
    (useGroupTitleIntegration as jest.Mock).mockReturnValue({
