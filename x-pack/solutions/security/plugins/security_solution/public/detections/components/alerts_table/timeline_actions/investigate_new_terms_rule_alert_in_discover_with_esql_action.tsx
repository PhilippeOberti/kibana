...
interface InvestigateNewTermsRuleAlertInDiscoverWithESQLActionProps {
  /**
   *
   */
  ecsData: Ecs;
 ...
 *
 */
export const InvestigateNewTermsRuleAlertInDiscoverWithESQLAction = memo(
  ({ ecsData }: InvestigateNewTermsRuleAlertInDiscoverWithESQLActionProps) => {
    const {
      services: { share },
    } = useKibana();
...
InvestigateNewTermsRuleAlertInDiscoverWithESQLAction.displayName =
  'InvestigateNewTermsRuleAlertInDiscoverWithESQLAction';
