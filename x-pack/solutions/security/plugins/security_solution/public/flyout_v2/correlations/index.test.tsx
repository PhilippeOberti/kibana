...
import { useShowRelatedAlertsByAncestry } from '../document/hooks/use_show_related_alerts_by_ancestry';
import { useShowRelatedAlertsBySameSourceEvent } from '../document/hooks/use_show_related_alerts_by_same_source_event';
import { useShowRelatedAlertsBySession } from '../document/hooks/use_show_related_alerts_by_session';
import { useShowRelatedAttacks } from '../../flyout/document_details/shared/hooks/use_show_related_attacks';
import { useShowRelatedCases } from '../document/hooks/use_show_related_cases';
import { useShowSuppressedAlerts } from '../document/hooks/use_show_suppressed_alerts';
import {
...
jest.mock('../document/hooks/use_show_related_alerts_by_ancestry');
jest.mock('../document/hooks/use_show_related_alerts_by_same_source_event');
jest.mock('../document/hooks/use_show_related_alerts_by_session');
jest.mock('../../flyout/document_details/shared/hooks/use_show_related_attacks');
jest.mock('../document/hooks/use_show_related_cases');
jest.mock('../document/hooks/use_show_suppressed_alerts');
