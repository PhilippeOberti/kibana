...
Here's a non-exhaustive list of the reusable component in the top-level `shared` folder. We recommend using these components to create a unified flyout experience. 
 ...
 - [FlyoutHeader](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [FlyoutHeaderTabs](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [FlyoutBody](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [FlyoutFooter](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [FlyoutError](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [FlyoutLoading](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [FlyoutTitle](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [AlertHeaderBlock](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui), [ExpandablePanel](https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-flyout-ui): from `@kbn/flyout-ui` — wrappers for flyout layout, loading/error states, title with icon, header block, and expandable panel.
